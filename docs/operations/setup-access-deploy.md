...
### Настройки сайта (Tenant Admin): вкладки

Страница **Настройки** в кабинете клиента разбита на вкладки: **Основное** (название и контакты), **Оформление** (логотип и цвета), при необходимости **Запись на занятия** (темы с программами), **Аналитика** (счётчики по ID), **Расширенные** (канонический URL и блок **Деньги и валюта**, по умолчанию свёрнут). Тексты подсказок и заголовки вкладок вынесены в `lang/ru/tenant_admin_settings.php`.
