...
| (нет публичного URL) | — | Список обновлений **tenant-продукта** доступен **только** в кабинете клиента (`/admin/.../whats-new`); данные в `platform_product_changelog_entries`; публичного `/changelog` на маркетинге нет |
