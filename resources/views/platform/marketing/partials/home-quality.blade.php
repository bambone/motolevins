<section id="uroven-produkta" class="pm-section-anchor border-b border-slate-200 bg-slate-50 py-12 sm:py-16 md:py-20" aria-labelledby="uroven-heading">
    <div class="mx-auto max-w-6xl px-3 sm:px-4 md:px-6">
        <h2 id="uroven-heading" class="text-balance text-xl font-bold leading-tight text-slate-900 sm:text-2xl md:text-3xl">RentBase — это не конструктор сайтов</h2>
        <p class="mt-3 max-w-3xl text-base font-semibold text-slate-800 sm:text-lg">Это рабочий инструмент для бизнеса.</p>
        <p class="mt-4 max-w-3xl text-sm leading-relaxed text-slate-600 sm:text-base">Для компаний, которым нужны заявки и бронирования в бою, а не «потестить бесплатно». Реальные проекты, без мусора в продукте, стабильная инфраструктура и развитие вместе с платящими клиентами.</p>
