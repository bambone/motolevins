    ...
    <div class="grid grid-cols-1 gap-5 sm:gap-6 md:grid-cols-12 md:gap-x-6 md:gap-y-6 lg:gap-x-14 lg:gap-y-10 xl:gap-x-16">
        @foreach($motorcycles as $m)
            ...
            <div class="min-w-0 md:col-span-6 lg:col-span-4">
                <a href="{{ route('booking.show', $m->slug) }}" class="glass-card group block h-full overflow-hidden rounded-2xl transition-shadow hover:shadow-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-moto-amber touch-manipulation">
