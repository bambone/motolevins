...
<section class="relative z-10 overflow-hidden border-t border-white/[0.02] py-20 sm:py-28 lg:py-36 xl:py-40">
    ...
    <div class="relative z-10 mx-auto max-w-4xl px-3 text-center sm:px-4 md:px-8">
        ...
        <div class="flex flex-col items-stretch justify-center gap-4 sm:flex-row sm:items-center sm:gap-5">
            <!-- Primary Final CTA -->
            <button type="button" @click="document.getElementById('catalog').scrollIntoView({behavior: 'smooth'})" class="tenant-btn-primary min-h-12 w-full px-8 py-3.5 text-base shadow-2xl transition-all duration-300 hover:-translate-y-0.5 sm:w-auto sm:min-h-14 sm:px-10 sm:py-4 sm:text-lg md:text-xl">
                {{ $buttonText }}
            </button>
            
            <!-- Secondary Contact Link -->
            <a href="https://wa.me/79130608689" target="_blank" rel="noopener noreferrer" class="tenant-btn-secondary min-h-12 w-full gap-3 px-8 py-3.5 text-base font-bold shadow-xl backdrop-blur-md transition-all duration-300 sm:w-auto sm:min-h-14 sm:px-10 sm:py-4 sm:text-lg md:text-xl">
