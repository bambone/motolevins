...
<section id="catalog" class="relative z-10 border-t border-white/[0.02] bg-[#0c0c0e] py-16 sm:py-20 lg:py-28">
    <div class="mx-auto max-w-7xl px-3 sm:px-4 md:px-8">
        ...
        <div class="grid grid-cols-1 gap-5 sm:gap-6 md:grid-cols-12 md:gap-x-6 md:gap-y-6 lg:gap-x-14 lg:gap-y-10 xl:gap-x-16" x-show="filteredBikes.length > 0">
            @foreach ($bikes as $index => $bike)
                <div
                    class="min-w-0 w-full transition-opacity duration-300 md:col-span-6 lg:col-span-4"
