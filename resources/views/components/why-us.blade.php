<section class="py-20 lg:py-28 relative z-10 bg-[#0c0c0e] border-y border-white/[0.02]">
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        <div class="mb-12 md:max-w-2xl">
            ...
            <p class="text-silver/80 text-lg">Премиальный подход к прокату мотоциклов. Никаких компромиссов в качестве сервиса и безопасности.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="bg-carbon rounded-2xl p-6 md:p-8 border border-white/5 hover:border-white/10 transition-colors flex flex-col sm:flex-row gap-6 items-start group">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white mb-2">Безупречное состояние</h3>
                    <p class="text-silver text-sm sm:text-base leading-relaxed">Вся техника проходит полный детейлинг и глубокое техническое обслуживание перед каждой выдачей. Мы следим за мотоциклами как за своими.</p>
                </div>
            </div>
            ...
            <div class="bg-carbon rounded-2xl p-6 md:p-8 border border-white/5 hover:border-white/10 transition-colors flex flex-col sm:flex-row gap-6 items-start group">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white mb-2">Прозрачные условия</h3>
                    <p class="text-silver text-sm sm:text-base leading-relaxed">Никаких скрытых платежей или внезапных доплат. Полная страховка без неприятных сюрпризов доступна для автопарка.</p>
                </div>
            </div>
            ...
            <div class="bg-carbon rounded-2xl p-6 md:p-8 border border-white/5 hover:border-white/10 transition-colors flex flex-col sm:flex-row gap-6 items-start group">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white mb-2">Быстрая поддержка 24/7</h3>
                    <p class="text-silver text-sm sm:text-base leading-relaxed">Мы всегда на связи. Поможем в дороге, проконсультируем по маршрутам, оперативно решим любые возникшие в поездке вопросы.</p>
                </div>
            </div>
            ...
            <div class="bg-carbon rounded-2xl p-6 md:p-8 border border-white/5 hover:border-white/10 transition-colors flex flex-col sm:flex-row gap-6 items-start group">
                ...
                <div>
                    ...
                    <p class="text-silver text-sm sm:text-base leading-relaxed">Вам не нужно везти с собой шлемы. Мы предоставляем чистую, продезинфицированную экипировку базового уровня при оформлении аренды.</p>
                </div>
            </div>
        </div>
    </div>
