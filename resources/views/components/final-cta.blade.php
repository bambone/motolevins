<section class="py-32 lg:py-40 relative z-10 border-t border-white/[0.02] overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 md:px-8 text-center relative z-10">
        ...
        <p class="text-silver/90 text-lg md:text-2xl mb-12 max-w-2xl mx-auto leading-relaxed drop-shadow-lg">
            Южные дороги уже ждут. Забронируйте поездку, которую захочется повторять снова и снова.
        </p>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <a href="https://wa.me/1234567890" target="_blank" class="w-full sm:w-auto px-10 py-5 bg-white/5 hover:bg-white/10 text-white font-bold rounded-xl transition-all duration-300 border border-white/10 hover:border-white/20 shadow-xl backdrop-blur-md text-xl flex items-center justify-center gap-3">
